...
public class GeofenceTransitionsJobIntentService extends JobIntentService {
    ...
    protected void onHandleWork(@NonNull Intent intent) {
        ...
        Log.d("JobIntentService", "!!!!!!!!!!!!!!!!!!!!!!BLABLABLABLA!!!!!!!!!!!!!!!!!!!!");
    ...
    private void sendNotification(String notificationType, String notificationDetails) {
        ...
        builder.setSmallIcon(R.drawable.ic_check_black_12dp)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(),
                        R.drawable.ic_check_black_12dp))
                .setContentTitle("KeyFinder")
                .setContentText("Are you leaving?")
                .setStyle(new NotificationCompat.BigTextStyle()
                        .bigText("Don't forget your keys! " + notificationType + notificationDetails))
